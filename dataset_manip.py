...
def load_dataset_k_fold(dataset_path, feature_delimiter, feature_member_delimiter, verbose=False, lstm_type=True,
                 test_run=False):
    ...
    t = datetime.now()
    print "\n[1] [K-FOLD] Dataset loading started... \n"
    print "Time: " + str(t)
